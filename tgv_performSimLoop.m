    ...
    for i = 1:length(time)
        ...
        if options.calcErrors
            ...
            if options.calcEnstrophy
                ...
                enst_n(i) = tgv_calcEnstrophy(Omega_n_now, options);
                enst_a(i) = tgv_calcEnstrophy(Omega_a_now, options);
                % Plot der kinetischen Energie
                tgv_plotEnstrophy(subplot(2, 3, 6, 'Parent', fig), time(1:i), enst_n(1:i), enst_a(1:i), options);
        ...
        [Psi_n_next, U_n_next, V_n_next, Omega_dot_n_next] = tgv_updateVariables(Omega_n_now, Psi_n_now, U_n_now, V_n_now, D1x, D1y, D1xp, D1xm, D1yp, D1ym, D2x, D2y, WH, WV, A_L, A_U, B, options);
        ...
        elseif strcmp(options.stepMethod, 'heun')
            ...
            Omega_dot_k2 = tgv_solveVorticity(U_n_next, V_n_next, Psi_n_next, Omega_pred, D1x, D1y, D1xp, D1xm, D1yp, D1ym, D2x, D2y, B, options);
