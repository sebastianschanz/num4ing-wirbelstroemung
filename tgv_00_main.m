...
function main()
    ...
    [X, Y, U_a, V_a, Psi_a, B, W] = tgv_02_initSimulation(options);  % Simulationsvariablen initialisieren
    tgv_03_performSimLoop(X, Y, U_a, V_a, Psi_a, B, W, options);  % Aktualisierungsschleife ausführen
end
